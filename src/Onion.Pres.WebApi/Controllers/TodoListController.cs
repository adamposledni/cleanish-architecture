...
public class TodoListController : BaseController
{
    ...
    {
        return StatusCode(201, await _todoItemService.CreateAsync(body, todoListId));
    }

    [ProducesResponseType(200)]
    [HttpPut("{todoListId}/items/{todoItemId}")]
    public async Task<ActionResult<TodoListRes>> UpdateTodoItem(Guid todoListId, Guid todoItemId, TodoItemUpdateReq body)
    {
        return StatusCode(200, await _todoItemService.UpdateAsync(body, todoListId));
    }
}
