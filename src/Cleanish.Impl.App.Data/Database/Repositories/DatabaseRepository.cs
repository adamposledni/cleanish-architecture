...
internal abstract class DatabaseRepository<TEntity> : IDatabaseRepository<TEntity> where TEntity : BaseEntity
{
    ...
    {
        return await ReadPaginatedData(Specification().Build(), pageSize, page, callerMethodName);
    }
